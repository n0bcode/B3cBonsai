...
// .NET Foundation cấp phép cho bạn tệp này theo giấy phép MIT.
#nullable disable
...
namespace B3cBonsaiWeb.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Trình duyệt hiện tại đã bị quên. Khi bạn đăng nhập lại từ trình duyệt này, bạn sẽ được yêu cầu nhập mã 2fa.";
